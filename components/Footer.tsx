...
const Footer = () => {
  return (
    <div className="mx-auto bg-pink-500 xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
      <div className="flex flex-col items-center justify-center">
        <div>
          <div aria-label="galinduh.co Logo" className="cursor-pointer">
            <h1 className="fill-stroke text-white text-gray-800 font-bold">
        ...
        <div className="flex items-center gap-x-6 mt-6">
          <div className="cursor-pointer">
            <a aria-label="Shopping bag" className="text-gray-800 dark:text-white rounded p-1" href="https://shopee.ph/galinduh.co">
          ...
          <div className="cursor-pointer">
            <a aria-label="Facebook" className="text-gray-800 dark:text-white rounded p-1" href="https://www.facebook.com/Galinduh.CoMain">
          ...
          <div className="cursor-pointer">
            <a aria-label="Instagram" className="text-gray-800 dark:text-white rounded p-1" href="https://www.instagram.com/galinduh.comain/">
          ...
          <div className="cursor-pointer">
            <a aria-label="Tiktok" className="text-gray-800 dark:text-white rounded p-1" href="https://www.tiktok.com/@galinduh.co">
        ...
        <div className="flex items-center mt-6">
          <p className="text-base text-white leading-4 text-gray-800">
            2023 <span className="font-semibold">Galinduh.Co</span>
          </p>
          <div className="border-l border-white pl-2 ml-2">
            <p className="text-base text-white leading-4 text-gray-800">Inc. All rights reserved</p>
          </div>
        </div>
      </div>
    </div>
